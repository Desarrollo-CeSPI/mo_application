...
cookbook 'mo_backup',           git: 'https://github.com/Desarrollo-CeSPI/mo_backup.git'
...
cookbook 'mo_monitoring_client',git: 'https://github.com/Desarrollo-CeSPI/mo_monitoring_client.git'
